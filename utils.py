...
def textDisplay(curve,img):
    pos_derecha = ((img.shape[1] - 150), 20)  # Parte superior derecha
    pos_izquierda = (20, 20)  # Parte superior izquierda
    pos_recto = ((img.shape[1] - 150) // 2, 20)  # Parte superior central

    color_derecha = (255, 0, 0)  # Rojo
    color_izquierda = (0, 255, 0)  # Verde
    color_recto = (0, 0, 255)  # Azul
